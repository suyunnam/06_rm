...
mod1_default_lmer <- lmer(yield_kgha ~ krate_kgha*nrate_kgha*fdap + (1|block/krate_kgha)
                          , data = rm_rcbd_df)
...
A few things to notice:  
  ...
  - **AIC and BIC columns**: the values we see here are specific to these models, and their magnitude is not really meaninful. What we are looking for here is **relative differences** when comparing models.   
